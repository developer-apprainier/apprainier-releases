# AppRainier SDK Release v2.1.0

This folder contains the AppRainier v2.1.0 client SDK release artifacts.

## What's Included

- `android/apprainier-android-sdk-2.1.0.aar`
- `android/apprainier-android-sdk-2.1.0.zip`
- `ios/AppRainierSdk.xcframework`
- `ios/AppRainierSdk-2.1.0.xcframework.zip`
- `flutter/flutter_apprainier_plugin-2.1.0`
- `flutter/flutter_apprainier_plugin-2.1.0.zip`
- `reactnative/react-native-apprainier-plugin-2.1.0`
- `reactnative/react-native-apprainier-plugin-2.1.0.zip`
- `web/apprainier-web-sdk-2.1.0`
- `web/apprainier-web-sdk-2.1.0.zip`
...
- Web carousel cards now render contained product images with stronger, readable title/subtitle overlays.
...
- Confirm the uploaded zip files are from this `v2.1` folder.
